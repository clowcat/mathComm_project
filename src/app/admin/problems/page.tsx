...
import { problemsAPI, getDifficultyLabel, calculateXP, categoryToTags } from "@/lib/supabase";
                      ...
                      <div className="flex gap-2">
                        <Button
                          onClick={() => {
                            ...
                            showToast(`✅ Added all ${relatedProblems.length} problems to the list!`, "success");
                          }}
                          size="sm"
                          className="bg-green-600 text-white font-medium text-xs hover:bg-green-700"
                        >
